...
Dicho código es leído desde el archivo principal para poder mostrar un resultado. Además se crearon dos archivos con formato txt, de esta forma será posible añadir los prototipos de funciones y las funciones respectivas que se establecieron en lenguaje ensamblador para que ésta última sea leída y se pueda realizar un análisis léxico, sintáctico y semántico y por supuesto, proporcionarnos el resultado final de la operación solicitada.
