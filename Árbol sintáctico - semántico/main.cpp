...
Nodo * arbol12(){
	...
	return new DefVar(new Tipo("int"), new Identificador("a", NULL), new DefFunc( new Tipo("int"), new Identificador("suma", NULL), new Parametro( new Tipo("int"), new Identificador("a"), 
	new Parametro( new Tipo("int"), new Identificador("b"), NULL)), 
	new Regresa(new Suma("+",new Identificador("a", NULL), new Identificador("b", NULL)) , NULL), NULL));
}
